...
<div id="myProductsPage" data-base-url="<?= e(rtrim(url(''), '/')) ?>" data-csrf-token="<?= e(csrf_token()) ?>">
    <div class="hero-card">
        <div class="hero-row">
            <div>
            ...
            <div class="hero-actions">
                <button class="btn btn-primary" type="button" data-open-add-modal>
        ...
        <?php if (empty($items)): ?>
            <div class="empty-state" style="padding:40px 20px;text-align:center;">
                ...
                <div style="display:flex;gap:10px;justify-content:center;flex-wrap:wrap;">
                    ...
                    <button class="btn btn-accent" type="button" data-open-add-modal>+ Thêm thủ công</button>
                </div>
            </div>
        <?php else: ?>
                            ...
                            <td data-label="Thao tác">
                                <div style="display:flex;gap:6px;flex-wrap:wrap;">
                                    ...
                                    <?php if ($hasAff && in_array($item['status'], ['active', 'pending'], true)): ?>
                                        <button class="btn btn-sm btn-success" type="button" data-generate-content-id="<?= $id ?>" title="Sinh content" style="padding:4px 8px;">✨</button>
                                    <?php endif; ?>
                                    <button
                                        class="btn btn-sm btn-ghost"
                                        type="button"
                                        data-archive-product-id="<?= $id ?>"
                                        data-archive-product-name="<?= e((string)$item['product_name']) ?>"
                                        title="Lưu trữ"
        ...
        <div class="modal-box" style="max-width:560px;">
            ...
            <form id="addForm">
                ...
                <div class="modal-actions">
                    ...
                    <button type="button" class="btn btn-cancel" data-close-modal="addModal">Hủy</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-box" style="max-width:560px;">
            ...
            <form id="editForm">
                ...
                <div class="modal-actions">
                    ...
                    <button type="button" class="btn btn-cancel" data-close-modal="editModal">Hủy</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-overlay" id="archiveModal" style="display:none;">
        <div class="modal-box" style="max-width:420px;">
            ...
            <div class="modal-actions">
                <button class="btn btn-primary" id="confirmArchiveButton" type="button" style="background:var(--danger);flex:1;">Lưu trữ</button>
                <button class="btn btn-cancel" type="button" data-close-modal="archiveModal">Hủy</button>
            </div>
        </div>
    </div>
</div>
